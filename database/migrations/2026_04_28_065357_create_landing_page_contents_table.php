...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('landing_page_contents', function (Blueprint $table) {
            ...
            $table->text('hero_description')->default('Уже 15 лет моя жизнь связана с психологией. Помогаю людям находить опору и контакт с собой через доверие и живое человеческое присутствие.');
            ...
            $table->text('seo_description')->default('Психолог, гештальт-терапевт. Помогаю найти опору и контакт с собой. Работаю с тревожностью, отношениями, кризисами и самоценностью. Онлайн и очно.');
